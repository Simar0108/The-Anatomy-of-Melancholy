...
K-Means and hierarchical (Ward) with k=3 on chunk embeddings. Cluster descriptions use top TF-IDF terms per cluster. Check cluster_vs_book.csv and cluster_vs_label.csv to see whether clusters align more with suffering type (label) or with book/author.
